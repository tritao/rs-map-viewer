export class Configuration {
    ...
    public static ARCHIVE_HASHES: number[] = [
        0, -1794511643, -1998798937, 1433713710, -1592896084, 999217025, -1741782021, -2063599502, 1123906948
    ];

    public static CLIENT_REVISION: number = 377;

    public static LOW_MEMORY = false;
}
