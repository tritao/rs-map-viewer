...
import { CacheViewerContainer } from "./CacheViewerContainer";
import 'dockview/dist/styles/dockview.css';

export function CacheViewerApp(): JSX.Element {
    const [searchParams, setSearchParams] = useSearchParams();

    const [errorMessage, setErrorMessage] = useState<string>();
    const [downloadProgress, setDownloadProgress] = useState<DownloadProgress>();
    const [cacheViewer, setCacheViewer] = useState<CacheViewer>();
    ...
    useEffect(() => {
        ...
        const load = async () => {
            ...
            const cacheViewer = new CacheViewer(workerPool, cacheList, cache);
            cacheViewer.applySearchParams(searchParams);
            setCacheViewer(cacheViewer);
    ...
    if (errorMessage) {
        ...
        content = <CacheViewerContainer cacheViewer={cacheViewer} />;
    }
